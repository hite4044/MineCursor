...
class ElementInfoEditorUI(wx.ScrolledWindow):
    def __init__(self, parent: wx.Window):
        ...
        widget_groups: list[GroupData] = [
            ...
            (("动画", True),
             ((IntEntry, "动画起始偏移"), (BoolEntry, "循环动画"), (BoolEntry, "反转动画"),
        ...
        self.reverse_animation: BoolEntry = ret[2]
        self.enable_key_ani: BoolEntry = ret[3]
        self.frame_start: IntEntry = ret[4]
        self.frame_inv: IntEntry = ret[5]
        self.frame_length: IntEntry = ret[6]
